...
@Autonomous(name = "LeftAutonomousREDTAPE - public void test", group="Autonomous")
//@Disabled
public class LeftAutonomousWebcam_publicvoid extends LinearOpMode {
	...
	public void turntableunfolded() { //this code will not run until called
		if(opModeIsActive()) {
	...
	public void turntablefolded() { //this code will not run until called
		if(opModeIsActive()) {
			turntable.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	public void spin90left() { //this code will not run until called
		if(opModeIsActive()) {
	...
	public void spin90right() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	public void forward4inches() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	public void backward4inches() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	public void right4inches() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	public void left4inches() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	public void forward1foot() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	public void backward1foot() { //this code will not run until called
		front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
		front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
		back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
		back_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	public void right1foot() { //this code will not run until called
	...
	public void left1foot() { //this code will not run until called
		...
		public void colorsensordrivebackred() {
	...
	public void colorsensordrivebackblue() {
		// hsvValues is an array that will hold the hue, saturation, and value information.
		float hsvValues[] = {0F, 0F, 0F};
	...
	public void leftblockautonomous() { //this code will not run until called
	...
	public void middleblockautonomous() { //this code will not run until called
	...
	public void rightblockautonomous() { //this code will not run until called
