...
//@Disabled
public class autonomousprogramLeft extends LinearOpMode {
	...
	static final double clawclosed_position = 0.15;
	
	static final double clawopen_position = 0.6;
	
	static final double claweject_position = 1;
	
	static final double backclawclosed_position = 0.4;
	
	static final double backclawopen_position = 0;
	
	static final double backclaweject_position = 1;
