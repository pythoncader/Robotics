...
@Autonomous(name = "LeftAutonomousREDTAPE - private void test", group="Autonomous")
//@Disabled
public class LeftAutonomousWebcam_privatevoid extends LinearOpMode {
	...
	private void turntableunfolded() { //this code will not run until called
		if(opModeIsActive()) {
	...
	private void turntablefolded() { //this code will not run until called
		if(opModeIsActive()) {
			turntable.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	private void spin90left() { //this code will not run until called
		if(opModeIsActive()) {
	...
	private void spin90right() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	private void forward4inches() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	private void backward4inches() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	private void right4inches() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	private void left4inches() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	private void forward1foot() { //this code will not run until called
		if(opModeIsActive()) {
			front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
			back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	private void backward1foot() { //this code will not run until called
		front_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
		front_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
		back_left.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
		back_right.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
	...
	private void right1foot() { //this code will not run until called
	...
	private void left1foot() { //this code will not run until called
		...
		private void colorsensordrivebackred() {
	...
	private void colorsensordrivebackblue() {
		// hsvValues is an array that will hold the hue, saturation, and value information.
		float hsvValues[] = {0F, 0F, 0F};
	...
	private void leftblockautonomous() { //this code will not run until called
	...
	private void middleblockautonomous() { //this code will not run until called
	...
	private void rightblockautonomous() { //this code will not run until called
