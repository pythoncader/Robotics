 ...
 */
@TeleOp(name = "Stone Detector OpMode - phoneCam", group="DogeCV")

public class StoneDetectorExamplephoneCam extends LinearOpMode {
    private OpenCvCamera phoneCam; //or webcam
    ...
    public void runOpMode() {
        ...
        //or webcam = OpenCvCameraFactory.getInstance().createWebcam(hardwareMap.get(WebcamName.class, "Webcam 1"), cameraMonitorViewId);
        ...
        //or webcam.setPipeline(stoneDetector);
        /*
        ...
        //or webcam.startStreaming(320, 240, OpenCvCameraRotation.UPRIGHT);
        /*
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.update();
            //or switch out phoneCam for webcam
            /*
            ...
            //switch out phoneCam variable for webcam
        }
    }
}