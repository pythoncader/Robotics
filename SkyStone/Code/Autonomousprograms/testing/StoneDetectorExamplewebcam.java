 ...
 */
@TeleOp(name = "Stone Detector OpMode - webcam", group="DogeCV")

public class StoneDetectorExamplewebcam extends LinearOpMode {
    private OpenCvCamera webcam; //or webcam
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive())
        {
            ...
            telemetry.update();
            //or switch out webcam for webcam
            /*
            ...
            //switch out webcam variable for webcam
        }
    }
}